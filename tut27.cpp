...
class complex{
    ...
    int b;
    public:
        friend int calculator::calcRealSum(complex,complex);    //since calcRealSum belongs to another class and not globbal scope, so used scope resolution operator
        friend int calculator::calcImSum(complex,complex);
